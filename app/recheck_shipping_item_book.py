...
def recheck_shipping_item_book():
    ...
    while True:
        ...
        ], page=page, page_size=page_size, sort_by=[(shipping_model.ShippingItem.id, 'asc')])
...
def modify_data(data, db, temp_isbn):
    ...
    if publisher:
        ...
        if book:
            ...
            shipping_model.update_shipping_item_by_temp_isbn(db, temp_isbn, {'book_id': book.book_id, 'isbn': isbn})
        print(f"-----")
